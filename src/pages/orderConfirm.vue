...
export default {
  ...
  data() {
    return {
      list: [], // 收获地址列表
      cartList: [], // 购物车中需要结算的商品列表(已选中状态的商品)
      cartTotalPrice: 0, // 商品总金额
      count: 0, // 商品结算件数
      checkedItem: {}, // 选中要操作的地址的对象
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get('/carts').then((res) => {
        ...
        this.cartList = list.filter(item => item.productSelected); // 过滤出购物车中选中的商品
        // 遍历计算已选中商品总数
